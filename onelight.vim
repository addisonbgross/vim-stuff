" -----------------------------------------------------------------------------
" File: onelight.vim
" Description: Onelight colorscheme for Lightline (itchyny/lightline.vim)
" Author: hallzy <hallzy.18@gmail.com> & <addisonbgross@gmail.com>
" Source: https://github.com/hallzy/lightline-onedark
" Last Modified: 8th Oct 2016
" -----------------------------------------------------------------------------
...
if exists('g:lightline')
  ...
  let s:p.normal.middle   = [ [ s:green, s:platinum ] ]
